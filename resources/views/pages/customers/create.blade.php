  ...
  <div class="offset-md-3 col-md-6">
    <div class="card">
      <div class="card-body">       
        ...
        <form action="{{ route('customer_store') }}" role="form" method="post">
          <input type="hidden" name="_token" value="{{ Session::token() }}">
          <div class="row">
            <div class="col-md-9 form-group {{ $errors->has('name') ? 'has-error' : '' }}">
              <label for="name_Input">Customer Name</label>
              <input type="text" name="name" value="{{ old('name') ?: '' }}" class="form-control" id="name_Input" placeholder="Enter customer name" autofocus required>
              @if ($errors->has('name'))
          ...
          <div class="row">
            <div class="col-md-5 form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
              ...
              <input type="text" name="phone" value="{{ old('phone') ?: '' }}" class="form-control" id="phone_Input" placeholder="Enter phone number" required>
              @if ($errors->has('phone'))
                <span class="help-block">
                    {{ $errors->first('phone') }}
                </span>
          ...
          <div class="row">
            <div class="col-md-12 form-group {{ $errors->has('gender') ? 'has-error' : '' }}">
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="gender_male_Input" name="gender" class="custom-control-input" value="1">
                <label class="custom-control-label" for="gender_male_Input">Male</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="gender_female_Input" name="gender" class="custom-control-input" value="2">
